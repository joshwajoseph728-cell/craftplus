...
// Internal sample author fixtures for showcase post feed demonstrations
const SAMPLE_AUTHOR_ALEXA: Profile = {
  id: 'user-001',
  username: 'alexa_design',
  full_name: 'Alexa Rivera',
  avatar_url: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&auto=format&fit=crop&q=80',
  headline: 'Lead Product Designer & Creative Technologist',
  bio: 'Lead Product Designer & Creative Technologist. Designing scalable design systems and accessible UI kits.',
  website: 'https://alexarivera.design',
  github_url: 'https://github.com/alexarivera',
  location: 'Tokyo, Japan',
  skills: ['Figma', 'Design Systems', 'Three.js', 'React', 'Tailwind CSS'],
  is_private: false,
  is_verified: true,
  open_to_collab: true,
  role: 'user',
...
const SAMPLE_AUTHOR_LEO: Profile = {
  id: 'user-002',
  username: 'leo_cyber',
  full_name: 'Leo Chen',
  ...
  bio: 'Senior Full-Stack & 3D Web Graphics Engineer. Crafting WebGPU shaders and procedural environments.',
  website: 'https://leochen3d.io',
  github_url: 'https://github.com/leochen3d',
  location: 'Singapore',
  skills: ['TypeScript', 'Rust', 'WebGPU', 'Blender', 'Next.js'],
  is_private: false,
  is_verified: true,
  open_to_collab: true,
  role: 'user',
...
const SAMPLE_AUTHOR_ELENA: Profile = {
  id: 'user-003',
  username: 'elena_ai',
  ...
  bio: 'AI Research Engineer & Computer Vision Specialist. Building open-source neural rendering pipelines.',
  website: 'https://elenarostova.ai',
  github_url: 'https://github.com/elenarostova',
  location: 'Berlin, Germany',
  skills: ['PyTorch', 'Python', 'CUDA', 'FastAPI', 'Docker'],
  is_private: false,
  is_verified: true,
  open_to_collab: true,
  role: 'user',
...
// No hardcoded profiles or default accounts: real accounts come from Supabase and user signups
export const INITIAL_PROFILES: Profile[] = [];

export const CURRENT_DEMO_USER: Profile | null = null;
...
export const INITIAL_POSTS: Post[] = [
  ...
  },
  {
    id: 'post-fun-3',
    user_id: 'user-001',
    project_title: '3D Blender Animation Reel & Claymation Loops 🎬🎨',
    category: 'Creative & 3D Art',
    work_status: 'Completed',
    open_to_collab: false,
    caption: 'Fun little weekend creative experiment! Practiced character rigging, squash-and-stretch physics, and soft studio lighting in Blender. Drop your favorite creative inspiration in the comments! 👇✨',
  ...
  },
  {
    id: 'post-fun-4',
    user_id: 'user-005',
    project_title: 'ASMR Mechanical Keyboard Build & Typing Sound Test ⌨️☕',
    category: 'Hardware & IoT',
    work_status: 'Completed',
    open_to_collab: false,
    caption: 'Custom 65% gasket-mount keyboard build with lubed holy panda switches and brass weight. Pure ASMR sound test for your focus sessions! 🎧',
